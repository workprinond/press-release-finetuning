# # bmw_lora_finetuning.py - COMPLETE READY-TO-RUN VERSION
...
#         # Training history
#         self.history = {'train_loss': [], 'eval_loss': [], 'learning_rate': []}
...
#     def train(self, num_epochs=3, batch_size=8, learning_rate=1e-4):
...
#     def generate_samples(self, prompts=None, max_length=100):
#         if prompts is None:
#             prompts = [
...
#         # Create 2x2 grid like second code
...
#     print("\n" + "="*60)
#     print("Starting Training (2-3 hours on CPU)")
#     print("="*60)
...
# bmw_lora_finetuning.py - ENHANCED VERSION WITH EARLY STOPPING & IMPROVED EVALUATION
